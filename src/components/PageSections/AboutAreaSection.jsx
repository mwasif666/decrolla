...
export default function AboutAreaSection(){
    return (
        <div id="about-two" className="about-section section-padding pb-100">
            <div className="container">
                <div className="row align-items-center">
                    ...
                    <div className="col-xl-3 col-lg-4 text-xl-center">
                        <Link to="/about">
                ...
                <div className="row">
                    ...
                    <div className="col-xl-3 col-lg-3">
                        <div className="about-content-wrapper">
                            <div className="heading-animation">
                                <h3>Archipix is a team of experienced architects and interior designers</h3>
                            </div>
                            <div className="p-animation">
                                <p>who are passionate about creating beautiful, functional spaces. We believe that good
                                    ...
                                    client's vision become reality.</p>
                            </div>
                        </div>
                    </div>
                </div>
